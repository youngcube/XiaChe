...
static NSString* const NOTIFICATION_FINISH_LOADING = @"notification_finish_loading";
static NSString* const NOTIFICATION_FINISH_DOWNLOAD = @"notification_finish_download";